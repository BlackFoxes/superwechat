...
public class PublicGroupsActivity extends BaseActivity {
    ...
    private void initView() {
        setContentView(cn.ucai.fulicenter.R.layout.activity_public_groups);
        pb = (ProgressBar) findViewById(cn.ucai.fulicenter.R.id.progressBar);
        listView = (ListView) findViewById(cn.ucai.fulicenter.R.id.list);
        searchBtn = (Button) findViewById(cn.ucai.fulicenter.R.id.btn_search);
        View footView = getLayoutInflater().inflate(cn.ucai.fulicenter.R.layout.listview_footer_view, null);
        footLoadingLayout = (LinearLayout) footView.findViewById(cn.ucai.fulicenter.R.id.loading_layout);
        footLoadingPB = (ProgressBar)footView.findViewById(cn.ucai.fulicenter.R.id.loading_bar);
        footLoadingText = (TextView) footView.findViewById(cn.ucai.fulicenter.R.id.loading_text);
...
//                                cursor = result.getCursor();
	...
	private class GroupsAdapter extends BaseAdapter implements SectionIndexer {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                ((TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.name)).setText(getItem(position).getMGroupName());
