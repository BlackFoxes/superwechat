...
public class GroupSimpleDetailActivity extends BaseActivity {
	...
	private NetworkImageView mv_avatar;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(cn.ucai.fulicenter.R.layout.activity_group_simle_details);
		tv_name = (TextView) findViewById(cn.ucai.fulicenter.R.id.name);
		tv_admin = (TextView) findViewById(cn.ucai.fulicenter.R.id.tv_admin);
		btn_add_group = (Button) findViewById(cn.ucai.fulicenter.R.id.btn_add_to_group);
		tv_introduction = (TextView) findViewById(cn.ucai.fulicenter.R.id.tv_introduction);
		progressBar = (ProgressBar) findViewById(cn.ucai.fulicenter.R.id.loading);
...
//		}).start();
	...
	public void addToGroup(View view){
		String st1 = getResources().getString(cn.ucai.fulicenter.R.string.Is_sending_a_request);
		final String st2 = getResources().getString(cn.ucai.fulicenter.R.string.Request_to_join);
		final String st3 = getResources().getString(cn.ucai.fulicenter.R.string.send_the_request_is);
		final String st4 = getResources().getString(cn.ucai.fulicenter.R.string.Join_the_group_chat);
		final String st5 = getResources().getString(cn.ucai.fulicenter.R.string.Failed_to_join_the_group_chat);
...
//		getResources().getString(R.string)
	...
	private void showGroupDetail() {
		 ...
		 UserUtils.setGroupBeanAvatar(groupid,mv_avatar);
     }
