...
//			uploadHeadPhoto();
	...
	private void updateRemoteNick(final String nickName) {
		dialog = ProgressDialog.show(this, getString(cn.ucai.fulicenter.R.string.dl_update_nick),
				getString(cn.ucai.fulicenter.R.string.dl_waiting));
				...
				if (!updatenick) {
					runOnUiThread(new Runnable() {
						public void run() {
							Toast.makeText(UserProfileActivity.this,
									getString(cn.ucai.fulicenter.R.string.toast_updatenick_fail), Toast.LENGTH_SHORT)
									.show();
							dialog.dismiss();
						}
					});
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							dialog.dismiss();
							Toast.makeText(UserProfileActivity.this,
									getString(cn.ucai.fulicenter.R.string.toast_updatenick_success), Toast.LENGTH_SHORT)
									.show();
...
//		}
	...
	private void updateUserAvatar() {
		dialog = ProgressDialog.show(this, getString(cn.ucai.fulicenter.R.string.dl_update_photo),
				getString(cn.ucai.fulicenter.R.string.dl_waiting));
		dialog.show();
		try {
