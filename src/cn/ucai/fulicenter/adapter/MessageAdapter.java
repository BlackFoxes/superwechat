	...
	private void setUserAvatar(final EMMessage message, NetworkImageView imageView){
	    ...
	    imageView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("gourpId", username);
						...
						public void run() {
							...
							if (message.status == EMMessage.Status.SUCCESS) {
								...
								Toast.makeText(activity,
										activity.getString(cn.ucai.fulicenter.R.string.send_fail) + activity.getString(cn.ucai.fulicenter.R.string.connect_failuer_toast), 0)
										.show();
								timer.cancel();
							}
